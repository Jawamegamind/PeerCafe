...
class TestRestaurantRoutes:
    ...
    @patch("routes.restaurant_routes.supabase")
    def test_create_restaurant_database_error(
        self, mock_supabase, client, sample_restaurant_data
    ):
    ...
    @patch("routes.restaurant_routes.supabase")
    def test_create_restaurant_failed_insert(
        self, mock_supabase, client, sample_restaurant_data
    ):
    ...
    @patch("routes.restaurant_routes.supabase")
    def test_get_all_restaurants_success(
        self, mock_supabase, client, sample_restaurant_data
    ):
    ...
    def test_get_all_restaurants_database_error(self, mock_supabase, client):
        ...
        # Mock database error
        mock_supabase.from_.return_value.select.return_value.execute.side_effect = (
            Exception("Database error")
        )
    ...
    @patch("routes.restaurant_routes.supabase")
    def test_update_restaurant_database_error(
        self, mock_supabase, client, sample_restaurant_data
    ):
        """Test restaurant update with database error"""
        # Mock database error
        mock_supabase.from_.return_value.update.return_value.eq.return_value.execute.side_effect = Exception(
            "Database error"
        )
