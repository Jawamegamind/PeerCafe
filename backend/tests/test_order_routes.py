...
def test_normalize_order_items_edge_cases():
    ...
    @patch("routes.order_routes._get_user_id_from_token")
    @patch("routes.order_routes.create_supabase_client")
    def test_get_my_orders_unauthorized_no_token(
        self, mock_supabase_client, mock_get_user_id
    ):
    ...
    def test_get_my_orders_empty_results(
        self, mock_supabase_client, mock_get_user_id, mock_normalize
    ):
    ...
    @patch("routes.order_routes._get_user_id_from_token")
    @patch("routes.order_routes.create_supabase_client")
    def test_get_my_orders_malformed_bearer_token(
        self, mock_supabase_client, mock_get_user_id
    ):
    ...
    @patch("routes.order_routes.create_supabase_client")
    def test_get_delivery_user_orders(self, mock_supabase_client, mock_order_response):
        """Test retrieving orders for a delivery user"""
        mock_client = Mock()
        mock_table = Mock()
        mock_select = Mock()
        mock_eq = Mock()
    ...
    @patch("routes.order_routes.create_supabase_client")
    def test_get_delivery_user_orders_empty(self, mock_supabase_client):
        """Test delivery user endpoint returns empty list when no orders"""
        mock_client = Mock()
        mock_table = Mock()
        mock_select = Mock()
        mock_eq = Mock()
    ...
    def test_get_delivery_user_orders_with_status_filter(
        self, mock_supabase_client, mock_order_response
    ):
        """Test retrieving delivery user orders with a status filter"""
        mock_client = Mock()
        mock_table = Mock()
        mock_select = Mock()
        mock_eq = Mock()
    ...
    def test_verify_delivery_success_from_picked_up(
        self, mock_supabase_client, mock_normalize, mock_order_response
    ):
    ...
    @patch("routes.order_routes.create_supabase_client")
    def test_verify_delivery_missing_code(self, mock_supabase_client):
    ...
    @patch("routes.order_routes.create_supabase_client")
    def test_verify_delivery_empty_code(self, mock_supabase_client):
    ...
    @patch("routes.order_routes.create_supabase_client")
    def test_verify_delivery_null_code(self, mock_supabase_client):
    ...
    @patch("routes.order_routes.create_supabase_client")
    def test_verify_delivery_order_not_found(self, mock_supabase_client):
    ...
    @patch("routes.order_routes.create_supabase_client")
    def test_verify_delivery_invalid_code(
        self, mock_supabase_client, mock_order_response
    ):
    ...
    @patch("routes.order_routes.create_supabase_client")
    def test_verify_delivery_code_already_used(
        self, mock_supabase_client, mock_order_response
    ):
    ...
    @patch("routes.order_routes.create_supabase_client")
    def test_verify_delivery_general_exception_handling(self, mock_supabase_client):
