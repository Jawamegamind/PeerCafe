...
class TestSupabaseDB:
    ...
    @patch.dict(
        os.environ,
        {"PROJECT_URL": "https://test.supabase.co", "API_KEY": "test_api_key_123"},
    )
    ...
    def test_create_supabase_client_success(self, mock_create_client):
        ...
        mock_create_client.assert_called_once_with(
            "https://test.supabase.co", "test_api_key_123"
        )
    ...
    @patch("database.supabase_db.create_client")
    def test_create_supabase_client_missing_env_vars(
    ...
    @patch.dict(os.environ, {"PROJECT_URL": "", "API_KEY": ""})
    @patch("database.supabase_db.create_client")
    ...
    def test_environment_variable_types(self):
        ...
        with patch.dict(
            os.environ,
            {"PROJECT_URL": "https://test.supabase.co", "API_KEY": "test_key_123"},
        ):
...
class TestDatabaseIntegration:
    ...
    def test_error_handling_in_operations(self, mock_create_client):
        ...
        mock_client.from_.return_value.select.return_value.execute.side_effect = (
