...
describe('Profile Pages', () => {
  describe('UserProfilePage', () => {
    it('renders user profile page correctly', () => {
      ...
      expect(
        screen.getByText(/this is a placeholder for the user profile page/i)
      ).toBeInTheDocument();
    });
  });
  ...
  describe('AdminProfilePage', () => {
    it('renders admin profile page correctly', () => {
      ...
      expect(screen.getByTestId('navbar')).toBeInTheDocument();
      expect(
        screen.getByRole('heading', { name: /admin profile/i })
      ).toBeInTheDocument();
      expect(
        screen.getByText(/this is a placeholder for the admin profile page/i)
      ).toBeInTheDocument();
    });
  });
});
